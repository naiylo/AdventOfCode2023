  ...
  for i in range(0,len(string)):
    if string[i] == "\n" or i == (len(string) - 1):
      ...
      for i in range (0,len(line)):
        if line[i].isdigit():
          if indexOfNumberOne == -1:
            indexOfNumberOne = i
          else:
            indexOfNumberTwo = i
      try:
        if indexOfNumberOne + indexOfNumberTwo > indexOfNumberOne:
          valueToAdd = int(line[indexOfNumberOne] + line[indexOfNumberTwo])
        else:
          valueToAdd = int(line[indexOfNumberOne] + line[indexOfNumberOne])
    ...
    if string[i] == "\n" or i == (len(string) - 1):
      ...
      for i in range(0,len(line)):
        for j in range(i + 1, len(line) + 1):
            combinations.append(line[i:j])
      for i in combinations:
        if i.isdigit() or i in dictionary:
          if indexOfNumberOne == 0:
            if i.isdigit():
              numberOne = i
            else:
              numberOne = dictionary[i]
            indexOfNumberOne = 1  
          else:
            if i.isdigit():
              numberTwo = i
            else:
              numberTwo = dictionary[i]
            indexOfNumberTwo = 1
      try: 
        if indexOfNumberOne + indexOfNumberTwo > indexOfNumberOne:
          valueToAdd = int(numberOne + numberTwo)
        else:
          valueToAdd = int(numberOne + numberOne)
        returnValue += valueToAdd
      except:
        returnValue += 0
...
if __name__ == "__main__":
  print("Result with the function calibrateValue:")
  print("Example 1:")
  print(calibrateValue(example1))
  print("Example 2:")
  print(calibrateValue(example2))
  print("Example 3:")
  print(calibrateValue(example3))
  print("Result with the function calibrateTrueValue:")
  print("Example 1:")
  print(calibrateTrueValue(example1))
  print("Example 2:")
  print(calibrateTrueValue(example2))
  print("Example 3:")
  print(calibrateTrueValue(example3))
