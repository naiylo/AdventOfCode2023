...
example3 = """
...
if __name__ == "__main__":
    ...
    print("Example 1:")
    print(findWay(example1))
    print("Example 2:")
    print(findWay(example2))
    print("Example 3:")
    print(findWay(example3))
    print("Result with findWayWithMultipleStarts:")
    print("Example 4:")
    print(findWayWithMultipleStarts(example4))
    print("Example 3:")
    print(findWayWithMultipleStarts(example3))